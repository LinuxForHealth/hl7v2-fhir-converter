...
class SimpleBiConditionTest {

    // EQUALS on strings tests
    @Test
    void simple_EQUALS_condition_tests() {
    ...
    @Test
    void simple_EQUALS_on_integers_condition_tests() {
    ...
    @Test
    void simple_EQUALS_INTEGER_condition_tests() {
    ...
    // NOT_EQUALS tests
    @Test
    void simple_NOT_EQUALS_condition_tests() {
    ...
    @Test
    void simple_NOT_EQUALS_on_integers_condition_tests() {
    ...
    @Test
    void simple_NOT_EQUALS_INTEGER_condition_tests() {
    ...
    // CONTAINS tests
    @Test
    void simple_CONTAINS_condition_tests() {
    ...
    // NOT_CONTAINS tests
    @Test
    void simple_NOT_CONTAINS_condition_tests() {
    ...
    // ENDS_WITH tests
    @Test
    void simple_ENDS_WITH_condition_tests() {
    ...
    // NOT_ENDS_WITH tests
    @Test
    void simple_NOT_ENDS_WITH_condition_tests() {
    ...
    // STARTS_WITH tests
    @Test
    void simple_STARTS_WITH_condition_tests() {
    ...
    @Test
    void simple_NOT_STARTS_WITH_condition_tests() {
    ...
    // GREATER_THAN tests
    @Test
    void simple_GREATER_THAN_condition_tests() {
    ...
    @Test
    void simple_GREATER_THAN_INTEGER_condition_tests() {
    ...
    // LESS_THAN tests
    @Test
    void simple_LESS_THAN_condition_tests() {
    ...
    @Test
    void simple_LESS_THAN_INTEGER_condition_tests() {
    ...
    @Test
    void simple_GREATER_THAN_OR_EQUAL_TO_condition_tests() {
    ...
    @Test
    void simple_GREATER_THAN_OR_EQUAL_TO_INTEGER_condition_tests() {
    ...
    @Test
    void simple_LESS_THAN_OR_EQUAL_TO_condition_tests() {
    ...
    @Test
    void simple_LESS_THAN_OR_EQUAL_TO_INTEGER_condition_tests() {
    ...
    // The caller expects all these comparisons to be TRUE
    private void directional_comparison_tests_expected_TRUE(Object value1, String comparison, Object value2) {
        ...
        contextVariables.put("var1", new SimpleEvaluationResult<Object>(value1));
        contextVariables.put("var2", new SimpleEvaluationResult<Object>(value2));
    ...
    // Directional comparisons are only true in one direction
    // The caller expects all these comparisons to be FALSE
