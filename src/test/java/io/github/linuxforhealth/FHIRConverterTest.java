  ...
  public void test_dosage_output() throws  IOException {
    String hl7message =
            "MSH|^~\\&|MyEMR|DE-000001| |CAIRLO|20160701123030-0700||VXU^V04^VXU_V04|CA0001|P|2.6|||ER|AL|||||Z22^CDCPHINVS|DE-000001\r" +
                    ...
                    "PD1|||||||||||02^REMINDER/RECALL - ANY METHOD^HL70215|N|20140730|||A|20140730|\r" +
                    "NK1|1|JONES^MARTHA^^^^^L|MTH^MOTHER^HL70063|1234 W FIRST ST^^BEVERLY HILLS^CA^90210^^H|^PRN^PH^^^555^5555555|\r" +
                    "ORC|RE||197023^CMC|||||||^Clark^Dave||1234567890^Smith^Janet^^^^^^NPPES^L^^^NPI^^^^^^^^MD\r" +
                    "RXA|0|1|20140730||08^HEPB-PEDIATRIC/ADOLESCENT^CVX|.5|mL^mL^UCUM||00^NEW IMMUNIZATION RECORD^NIP001|1234567890^Smith^Janet^^^^^^NPPES^^^^NPI^^^^^^^^MD |^^^DE-000001||||0039F|20200531|MSD^MERCK^MVX|||CP|A\r" +
                    "RXR|C28161^INTRAMUSCULAR^NCIT|LA^LEFT ARM^HL70163\r" +
