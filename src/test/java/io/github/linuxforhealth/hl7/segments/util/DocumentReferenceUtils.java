...
public class DocumentReferenceUtils {
  ...
  public static DocumentReference createDocumentReferenceFromHl7Segment(String inputSegment){
    ...
    return getDocumentReferenceFromResource(documentReference.get(0));
  }  

  private static DocumentReference getDocumentReferenceFromResource(Resource resource) {
