...
public class ImmunizationUtils {
  ...
  public static Immunization createImmunizationFromHl7Segment(String inputSegment){
    ...
    return getImmunizationFromResource(immunization.get(0));
  }  

  private static Immunization getImmunizationFromResource(Resource resource) {
