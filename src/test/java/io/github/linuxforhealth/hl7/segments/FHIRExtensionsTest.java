...
public class FHIRExtensionsTest {
  ...
  public void simple_extensions_test() {
    ...
    Extension ext = patient.getExtensionByUrl(ExtensionUrlLookup.getExtensionUrl("mothersMaidenName"));
    assertThat(ext).isNotNull();
    assertThat(ext.getValue()).hasToString("MotherMaiden");
    ext = patient.getExtensionByUrl(ExtensionUrlLookup.getExtensionUrl("religion"));
    assertThat(ext).isNotNull();
