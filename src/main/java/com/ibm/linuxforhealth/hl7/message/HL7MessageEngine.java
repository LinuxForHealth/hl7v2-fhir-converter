...
import com.ibm.linuxforhealth.fhir.FHIRResourceMapper;
...
public class HL7MessageEngine implements MessageEngine {
   ...
   * 
   * @see com.ibm.linuxforhealth.api.MessageEngine#transform(com.ibm.linuxforhealth.api.InputDataExtractor,
